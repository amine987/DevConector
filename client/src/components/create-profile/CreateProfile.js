  ...
  class CreateProfile extends Component {
   ...
   constructor(props) {
    ...
    render() {
      ...
      const options = [
        { label: '* Select Professionnal Status', value: 0 },
        ...
        { label: 'Instructor or Teacher', value:'Instructor orTeacher' },
                ...
                Go Back
                  ...
                  <h1 className="display-4 text-center">
                    ...
                    <p className="lead text-center">
                        Lets get some informations to make your   profile stand out
                    </p>
                  ...
                  <form onSubmit={this.onSubmit}>
                      <TextFieldGroup
                         ...
                         />
                          ...
                          info="Could be youe website or a company one"
                          />
                          <TextFieldGroup
                          ...
                          onChange={this.onChange}
                          error={errors.skills}
                          info="Please use seperated comma values (eg.HTML,CSS,JavaScript,PHP)"
                          />
                          <TextFieldGroup
